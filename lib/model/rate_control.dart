...
class RateControl {
  ...
  @JsonKey(name: 'FrameRateLimit', fromJson: OnvifUtil.nullableMappedToInt)
  ...
  ///encoded ...)
  @JsonKey(name: 'EncodingInterval', fromJson: OnvifUtil.nullableMappedToInt)
  final int? encodingInterval;

  ///the maximum output bitrate in kbps
  @JsonKey(name: 'BitrateLimit', fromJson: OnvifUtil.nullableMappedToInt)
